...
describe('<Game />', () => {
    ...
    it('Can start a new game', () => {
        ...
        // Mess up the state to simulate an existing game
        wrapper.setState({
            guesses: [8, 24, 81],
            feedback: 'Awesome',
            correctAnswer: -1 
    ...
    it('Can make guesses', () => {
        const wrapper = shallow(<Game />);
        //Set correct answer to know what we are aiming for
        wrapper.setState({
            correctAnswer: 100
        });
    ...
    it('Can generate aural updates', () => {
        ...
        expect(wrapper.state('auralStatus')).toEqual('Here\'s the status of the game right now: You\'ve mae 3 guesses. In order of most- to least-recent, they are: 90, 3, 25');
    });
});